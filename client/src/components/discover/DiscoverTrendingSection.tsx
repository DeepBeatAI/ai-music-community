...
/**
 * DiscoverTrendingSection Component
 * 
 * Wrapper component for displaying trending tracks or popular creators on the Discover page.
 * Fetches all four data sources but only renders sections based on the type prop.
 * 
 * @param type - 'tracks' to show trending tracks sections, 'creators' to show popular creators sections
 */
  ...
  async function loadAnalytics() {
    ...
    try {
      ...
      const [t7d, tAll, c7d, cAll] = await Promise.all([
        getCachedAnalytics('discover_trending_7d', getTrendingTracks7Days),
        getCachedAnalytics('discover_trending_all', getTrendingTracksAllTime),
        getCachedAnalytics('discover_creators_7d', getPopularCreators7Days),
        getCachedAnalytics('discover_creators_all', getPopularCreatorsAllTime),
      ]);
      ...
      console.error('Error loading discover analytics:', err);
