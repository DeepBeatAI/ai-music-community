 ...
 * TrackCard Component
 * 
 * Displays a track card with cover art, metadata, membership badges, and actions menu.
 ...
 * 
 * Requirements: 3.4, 3.5, 3.6, 3.7, 3.8, 3.12
 */
        ...
        <div className="flex items-center justify-between text-sm text-gray-400">
          ...
          <div className="relative">
            ...
            {showActions && (
              ...
              >
                <button
                  onClick={() => handleAction(() => onAddToAlbum(track.id))}
