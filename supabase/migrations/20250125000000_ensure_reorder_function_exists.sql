-- Migration: Ensure reorder_playlist_tracks function exists
-- Description: Creates the function if it doesn't exist, or replaces it if it does
...
BEGIN
  ...
  -- Update each track position (playlist_tracks table doesn't have updated_at column)
